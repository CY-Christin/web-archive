function Empty({ className }: { className?: string }) {
  return (
    <div className={`${className} flex flex-col items-center justify-center flex-1 gap-3`}>
      <svg xmlns="http://www.w3.org/2000/svg" width={80} height={80} viewBox="0 0 128 128" className="opacity-90">
      ...
      <div className="text-xl font-semibold text-muted-foreground">No Data</div>
    </div>
  )
}
